...
class Router {
    ...
    public function match($url) {
        ...
        // Elimina BASE_URL de la URL solicitada
        $url = str_replace(BASE_URL, '', $url);

        // Extrae solo la ruta de la URL
        //$url = parse_url($url, PHP_URL_PATH);
        ...
        foreach ($this->routes as $route => $params) {
            ...
            // Reemplaza los parámetros de la ruta con regex
            ...
            if (preg_match('/^' . $routePattern . '$/', $url, $matches)) {
                ...
                // Si hay un parámetro por URL, se queda solo con él y desecha el resto
                array_shift($matches);
